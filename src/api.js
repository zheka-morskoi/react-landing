const ResumeAPI = {
  allData: {
    main: {
      ...
      description:
        'I design and program websites and web applications of all types. I also teach web dev courses',
      ...
      email: 'megaweb.jacksparrow@gmail.com',
      phone: '555-555-5555',
      address: {
        street: '3540 West Sahara Ave',
        city: 'Las Vegas',
        state: 'NV',
        zip: '89102-5816'
      },
